...
!!! tip "**Knob Set Shortcut**"

    You can change Knobs Sets by holding down the Back button and turning the encoder.
    
    The Back button's color will indicate the Knob Set number:
